...
public final class OfflineMovieRepository: MovieRepositoryProtocol, @unchecked Sendable {

    private let remote: MovieRepositoryProtocol
    private let store: OfflineStore
    private let monitor: NetworkMonitor

    public init(remote: MovieRepositoryProtocol, store: OfflineStore, monitor: NetworkMonitor) {
        self.remote = remote
        self.store = store
    ...
    private func fetchWithCache<T: Codable & Sendable>(
        key: String,
        type: T.Type,
